...
yet support NumPy 2.x. This does not change the analysis or the model
results; it makes local reproduction more reliable. This version pin was
added after testing the project on my old laptop, where the base
Anaconda environment contained older compiled packages that conflicted
with NumPy 2.x. The reproducibility notebook
`RUN_ME_REPRODUCE.ipynb` records the manual end-to-end checks I ran after
